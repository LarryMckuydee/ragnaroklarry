...
int mob_dead(struct mob_data *md, struct block_list *src, int type)
{
	...
	if( !rebirth ) { // Only trigger event on final kill
		...
		if( md->npc_event[0] && !md->state.npc_killmonster ) {
			...
			//added by Larry--------------------------------------------------------------
			pc_setparam(sd, SP_KILLEDRIDX, sd->bl.x);
			pc_setparam(sd, SP_KILLEDRIDY, sd->bl.y);
			//--------------------------------------------------------------------------------------
			...
			//added by Larry--------------------------------------------------------------
			pc_setparam(mvp_sd, SP_KILLEDRIDX, sd?sd->bl.x:-1);
			pc_setparam(mvp_sd, SP_KILLEDRIDY, sd?sd->bl.y:-1);
			//--------------------------------------------------------------------------------------
			...
			//added by Larry--------------------------------------------------------------
			pc_setparam(mvp_sd, SP_KILLEDRIDX, md->bl.x);
			pc_setparam(mvp_sd, SP_KILLEDRIDY, md->bl.y);
			//--------------------------------------------------------------------------------------

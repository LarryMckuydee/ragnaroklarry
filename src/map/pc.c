...
int pc_dead(struct map_session_data *sd,struct block_list *src)
{
	...
	if (src && src->type == BL_PC) {
		...
		//-------Added by Larry to track monster position----
		pc_setparam(ssd, SP_KILLEDRIDX,sd->bl.x);
		pc_setparam(ssd, SP_KILLEDRIDY,sd->bl.y);
		//-------------------------------------
...
int pc_readparam(struct map_session_data* sd,int type)
{
	...
	switch(type) {
		...
		//added by Larry to track monster position x and y
		case SP_KILLEDRIDX:      val = sd->killedridx; break;
		case SP_KILLEDRIDY:      val = sd->killedridy; break;
		//-------------------------------------------------------------------------------------------------------
